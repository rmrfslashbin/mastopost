...
build:
	...
	@printf "    linux  :: arm64"
	@GOOS=linux GOARCH=arm64 go build -o bin/mastopost-linux-arm64 main.go
	@printf " done.\n"
	@printf "    linux  :: amd64"
	@GOOS=linux GOARCH=amd64 go build -o bin/mastopost-linux-amd64 main.go
	@printf " done.\n"
	@printf "    darwin :: amd64"
	@GOOS=darwin GOARCH=amd64 go build -o bin/mastopost-darwin-amd64 main.go
	@printf " done.\n"
	@printf "    darwin :: arm64"
	@GOOS=darwin GOARCH=arm64 go build -o bin/mastopost-darwin-arm64 main.go
	@printf " done.\n"
